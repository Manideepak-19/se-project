...
class Blood_Bank:
    def __init__(self,root):
        ...
        #background 
        img=Image.open(r"D:\PROJECTS\images\bg1.jpg")
        ...
        tlabel=Label(bg_img,text="BLOOD BANK",font=("times new roman",40,"bold"),bg="black",fg="RED")
        ...
        b3.place(x=500,y=130,width=234,height=200)

        b3=Button(bg_img,text="Donar Details",command=self.dnr,cursor="hand2",font=("times new roman",15,"bold"),bg="blue",fg="white")
        b3.place(x=500,y=330,width=234,height=50)
        ...
        b4.place(x=500,y=450,width=234,height=200)

        b4=Button(bg_img,command=self.rec,text="Recipient Details",cursor="hand2",font=("times new roman",15,"bold"),bg="blue",fg="white")
        b4.place(x=500,y=650,width=234,height=50)
     
        #button-3
        img5=Image.open(r"D:\PROJECTS\images\availability.jpg")
        ...
        b5.place(x=800,y=130,width=234,height=200)

        b5=Button(bg_img,command=self.ava,text="Check Availability",cursor="hand2",font=("times new roman",15,"bold"),bg="blue",fg="white")
        b5.place(x=800,y=330,width=234,height=50)

        #button-4
        img6=Image.open(r"D:\PROJECTS\images\admin.jpg")
        ...
        b6.place(x=800,y=450,width=234,height=200)

        b6=Button(bg_img,command=self.log,text="Login as Admin",cursor="hand2",font=("times new roman",15,"bold"),bg="blue",fg="white")
        b6.place(x=800,y=650,width=234,height=50)
